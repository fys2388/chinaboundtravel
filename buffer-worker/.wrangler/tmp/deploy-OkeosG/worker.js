...
var worker_default = {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/debug-boards") {
      ...
      const queries = [
        { name: "account_organizations", query: "query { account { organizations { id name channels { id name service } } } }" },
        { name: "channels_with_boards", query: "query { channels { id name service metadata { ... on PinterestMetadata { boards { id name serviceId url } } } } }" },
        { name: "account_channels", query: "query { account { channels { id name service } } }" }
      ];
      const results = {};
