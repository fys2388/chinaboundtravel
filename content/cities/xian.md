...
tags = ["xian", "terracotta warriors", "silk road", "ancient capital", "central china"]
+++
...
**Getting there:** Bus 306 from Xi'an Railway Station (1 hour) or Didi (~150 RMB). Go early.
**Pro tip:** Hire a guide at the entrance or use an audio guide. The context makes it 10x better.
...
**Day 1:** Terracotta Warriors (morning) → Huaqing Hot Springs (optional, on the way back) → Muslim Quarter dinner and night market
**Day 2:** Ancient City Wall bike ride (morning) → Shaanxi History Museum → Big Wild Goose Pagoda fountain show
