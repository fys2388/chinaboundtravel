...
Generated: 2026-09-13  |  Deterministic audit, no network

## Nodes
| Node | content_id | Inbound links | Commercial layer |
|---|---|---|---|
| China Transportation Guide | cbt-17c6738ffb32 | 8 | none |
| High-Speed Rail Booking | cbt-cc4549872c92 | 3 | none |
| China Transportation Card | cbt-55aef784e6aa | 7 | comparison-layer |
| China Airport Transfer | cbt-02a3e0d6ed4f | 5 | comparison-layer |

## Link graph (directed, A -> B)
| From | To | Links |
|---|---|---|
| China Transportation Guide | China Transportation Card | 3 |
...
| High-Speed Rail Booking | China Airport Transfer | 1 |
| China Transportation Card | China Transportation Guide | 4 |
| China Transportation Card | High-Speed Rail Booking | 2 |
| China Transportation Card | China Airport Transfer | 2 |
| China Airport Transfer | China Transportation Guide | 3 |
| China Airport Transfer | High-Speed Rail Booking | 1 |
| China Airport Transfer | China Transportation Card | 2 |
